...
public class HttpUtil {
   // private static final Logger L = Logger.getLogger(HttpUtilogclass);
    ...
    public static String[]sendPost(String url, String jsonString,String accesscode,String origin, int timeout) throws Exception {
        ...
        log.info("========================== the response code from eedc: "+responseCode);
        ...
        in.close();
        String[]resp = {responseCode+"",response.toString()};
        log.info("============================the raw response from eedc: "+response);
        //print result
        return resp;
