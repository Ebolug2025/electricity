package com.etranzact.vasgate.electricity.ikedc.service;
...
import com.etranzact.vasgate.electricity.ikedc.util.*;
...
public class IKEDCProcessor extends PHCNNode {
 ...
 //   private static Logger logger = null;
    ...
    @Value("${IKEDC_VERIFYENDPOINT}")
    private String verifyEndpoint;
    @Value("${IKEDC_REQUERY_ENDPOINT}")
    private String requeryeNDPOINT;
    @Value("${IKEDC_PAYMENTENDPOINT}")
    private String IKEDC_PAYMENTENDPOINT;

    private String authEndpoint;

    private String encpinEndpoint;

    private String requestSignature_key;

    private static String payvicepin;

    @Value("${IKEDC_SIGNATURE_KEY}")
    private static String token;
    @Value("${IKEDC_DEFAULT_NO}")
    ...
    @Value("${IKEDC_BUSINESS_ID}")
    private String IKEDC_BUSINESS_ID;
    @Value("${IKEDC_PRODUCT_ID}")
    private static String PRODUCT_ID;
    @Value("${IKEDC_METER_NUMBER}")
