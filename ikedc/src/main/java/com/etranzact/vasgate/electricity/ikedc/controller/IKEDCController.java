...
import com.etranzact.vasgate.electricity.ikedc.service.IKEDCProcessor;
...
public class IKEDCController {
    ...
    @PostMapping("/query")
    ElectricityQueryResponse query(@RequestBody ElectricityQueryRequest electricityQueryRequest){
