 ...
 * http://juliusdavies.ca/commons-ssl/ As the above project is accepted into
 * Apache and its JARs become available in the Maven 2 repos, we will have to
 * switch to using the JARs instead
 * ************************************************************************ <p/>
