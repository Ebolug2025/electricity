...
public class HTTPUtils {
    ...
    //private static final String RESTFUL_SERVICE_RESPONSE = "REST";
    ...
    public static String[] doAllREQUEST(int requestMethod, int contentType, String theURL, String jsonParams, Map<String, String> headers, int timeoutSec, int ssl) {
        ...
        //LOGGER.log(Level.INFO, "output :::: ", outcome + " ====>\n " + theURL);
    ...
    public static String[] doGETRequest(String methodType, String contentType, String theURL, int timeoutSec, boolean enableSSL) {
    ...
    public static String doPOSTRequest2(String methodType, String contentType, String theURL, String jsonParams, Map<String, String> headers, int timeoutSec, boolean enableSSL) {
        String outcome = null;
        try {
            theURL = theURL.trim();
            if (enableSSL) {
            ...
            if (responseCode == HttpURLConnection.HTTP_ACCEPTED) {
                ...
                in.close();
                outcome = response.toString();
                //LOGGER.log(Level.INFO, " ERROR STREAM :{0}", outcome);
            }
        } catch (IOException x) {
    ...
    public static String[] doPOSTRequest(String methodType, String contentType, String theURL, String jsonParams, Map<String, String> headers, int timeoutSec, boolean enableSSL) {
        String[] outcome = {"", ""};
        try {
            theURL = theURL.trim();
            if (enableSSL) {
    ...
    public static String doPOSTReq(String methodType, String contentType, String theURL, String request, Map<String, String> headers, int timeoutSec, boolean enableSSL) {
        String outcome = null;
        try {
            theURL = theURL.trim();
            if (enableSSL) {
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                ...
                in.close();
                outcome = response.toString();
                //LOGGER.log(Level.INFO, " Exception occur :{0}", outcome);
            }
        } catch (Exception x) {
            x.printStackTrace();
            //LOGGER.log(Level.SEVERE, "Exception occur :::: ", x);
